...
<div class="slider-video__wrap">
	<div class="slider-video__container">
		<div class="slider-video">
			<div class="slide">
				<iframe src="//www.youtube.com/embed/J_83e2TcMcg" allowfullscreen></iframe>
			</div>

			<!-- 1 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/aYkNVIKFLIU" allowfullscreen></iframe>-->
<!--			</div>-->

			<!-- 2 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/R8D-Ylhy8nU" allowfullscreen></iframe>-->
<!--			</div>-->

			<!-- 3 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/yFQWfm6JY9E" allowfullscreen></iframe>-->
<!--			</div>-->

			<!-- 4 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/aYy7cc7sWzc" allowfullscreen></iframe>-->
<!--			</div>-->

			<!-- 5 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/iy91QcBzNxQ" allowfullscreen></iframe>-->
<!--			</div>-->

			<!-- 6 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/3yKfAA3LGlg" allowfullscreen></iframe>-->
<!--			</div>-->

			<!-- 7 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/g4d0IHj5rEE" allowfullscreen></iframe>-->
<!--			</div>-->

			<!-- 8 -->
<!--			<div class="slide">-->
<!--				<iframe width="800" height="450" src="//www.youtube.com/embed/V028imJYeVY" allowfullscreen></iframe>-->
<!--			</div>-->
		</div>
